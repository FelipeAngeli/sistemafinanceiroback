...
class TestDashboardAPI:
    ...
    @pytest.fixture
    async def session_id(self, client: AsyncClient, patient_id: str) -> str:
    ...
    async def test_get_dashboard_summary_success(
        ...
        assert isinstance(financial["total_revenue"], (int, float))
        assert isinstance(financial["total_paid"], (int, float))
        assert isinstance(financial["total_pending"], (int, float))
    ...
    @pytest.mark.asyncio
    async def test_get_dashboard_summary_invalid_dates(self, client: AsyncClient):
    ...
    @pytest.mark.asyncio
    async def test_get_dashboard_summary_period_too_large(self, client: AsyncClient):
    ...
    @pytest.mark.asyncio
    async def test_get_dashboard_summary_missing_params(self, client: AsyncClient):
