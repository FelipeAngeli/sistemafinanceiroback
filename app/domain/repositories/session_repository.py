...
class SessionRepository(ABC):
    ...
    async def get_by_id(self, session_id: UUID) -> Optional[Session]:
        ...
        Returns:
            Session se encontrada, None caso contrário.
        """
        ...
    ...
    async def list_by_patient(self, patient_id: UUID) -> List[Session]:
        ...
        Returns:
            Lista de sessões do paciente, ordenadas por data.
        """
        ...
    ...
    async def list_recent(self, limit: int = 10) -> List[Session]:
        ...
        Returns:
            Lista das sessões mais recentes, ordenadas por data descendente.
        """
        ...
